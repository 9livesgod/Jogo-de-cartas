...
def main():    
    ...
    score_button = pygwidgets.TextButton(window, (20, 30), 'All Time Scores', width=100, height=55)
    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            if score_button.handleEvent(event):
                
                my_Leaderboard = Leaderboard(window)
                top10_scores = leaderboard.scores()
                my_Leaderboard.mostrar_pontuacoes(top10_scores)
