...
if (leaderboard.verificar_player(username) == 2 or leaderboard.verificar_player(username) == False): 
    #se nao tem nenhum player existente na base de dados ou se o player ainda nao existe, entra na condicao
    leaderboard.adicionar_player(username) #adiciona o novo player a nossa base de dados com uma pontuacao 100 
...
class Game:
    ...
    def __init__(self, window):
        ...
        self.score = leaderboard.inicializar_score(username)
    ...
    def evaluate_guess(self, user_guess):
        ...
        leaderboard.atualizar_score(username, self.score)
        return finish
